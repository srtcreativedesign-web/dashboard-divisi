...
export function CommandPalette({ isOpen, onClose, onSelectAction }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = useMemo(
    () => [
      ...
      {
        id: 'act-scale-comfortable',
        title: 'Ubah Ukuran Tampilan: Nyaman (110%)',
        description: 'Perbesar ukuran font, kartu, tabel, dan form untuk kenyamanan visual',
        category: 'Aksi Cepat',
        icon: Scaling,
        keywords: ['ukuran', 'zoom', 'scale', 'resize', 'besar', 'nyaman', 'tampilan', '110'],
      },
      {
        id: 'act-scale-large',
        title: 'Ubah Ukuran Tampilan: Besar (120%)',
        description: 'Setel ukuran ekstra besar agar sangat jelas dan terbaca dari jarak jauh',
        category: 'Aksi Cepat',
        icon: Scaling,
        keywords: ['ukuran', 'zoom', 'scale', 'resize', 'ekstra besar', '120'],
      },
      {
        id: 'act-scale-standard',
        title: 'Ubah Ukuran Tampilan: Standar (100%)',
        description: 'Kembalikan ukuran antarmuka dashboard ke skala bawaan 100%',
        category: 'Aksi Cepat',
        icon: Scaling,
        keywords: ['ukuran', 'zoom', 'scale', 'reset', 'standar', 'normal', '100'],
      },
      {
        id: 'act-scale-zoom-in',
        title: 'Perbesar Ukuran Tampilan (+10%)',
        description: 'Naikkan tingkat skala antarmuka satu tingkat lebih besar',
        category: 'Aksi Cepat',
        icon: ZoomIn,
        keywords: ['zoom in', 'perbesar', 'tambah ukuran', 'scale up'],
        shortcut: 'Alt++',
      },
      {
        id: 'act-scale-zoom-out',
        title: 'Perkecil Ukuran Tampilan (-10%)',
        description: 'Turunkan tingkat skala antarmuka satu tingkat lebih kecil',
        category: 'Aksi Cepat',
        icon: ZoomOut,
        keywords: ['zoom out', 'perkecil', 'kurang ukuran', 'scale down'],
        shortcut: 'Alt+-',
      },
    ],
    [],
